...
> Άνοιγμα αυτής της σελίδας στο [https://mantzoutec.github.io/microbit/](https://mantzoutec.github.io/microbit/)
...
* αναζήτηση για **https://github.com/mantzoutec/microbit** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/mantzoutec/microbit/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/mantzoutec/microbit** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/mantzoutec/microbit/raw/master/.github/makecode/blocks.png)
